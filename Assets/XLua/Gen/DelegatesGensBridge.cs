...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp12(ref string p0, out string p1, out bool p2, out string p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp14(TestLuaCallCs p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(TestCsCallLua.Func1))
			{
			    return new TestCsCallLua.Func1(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(LuaCallCS1.Diopose))
			{
			    return new LuaCallCS1.Diopose(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(TestLuaCallCs.Del1))
			{
			    return new TestLuaCallCs.Del1(__Gen_Delegate_Imp0);
			}
		    ...
		    if (type == typeof(TestCsCallLua.Func3))
			{
			    return new TestCsCallLua.Func3(__Gen_Delegate_Imp2);
			}
		    ...
		    if (type == typeof(TestCsCallLua.Func2))
			{
			    return new TestCsCallLua.Func2(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(TestCsCallLua.Func4))
			{
			    return new TestCsCallLua.Func4(__Gen_Delegate_Imp12);
			}
		
		    if (type == typeof(TestCsCallLua.Func5))
			{
			    return new TestCsCallLua.Func5(__Gen_Delegate_Imp13);
			}
		
		    if (type == typeof(TestLuaCallCs.Del))
			{
			    return new TestLuaCallCs.Del(__Gen_Delegate_Imp14);
			}
