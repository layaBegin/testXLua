...
namespace XLua.CSObjectWrap
{
    ...
    public class testEventLuaEventWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(testEvent.LuaEvent);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new testEvent.LuaEvent();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to testEvent.LuaEvent constructor!");
        ...
        static int _g_get_luaScript(RealStatePtr L)
        {
		    try {
                ...
                testEvent.LuaEvent gen_to_be_invoked = (testEvent.LuaEvent)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_injections(RealStatePtr L)
        {
		    try {
                ...
                testEvent.LuaEvent gen_to_be_invoked = (testEvent.LuaEvent)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.injections = (testEvent.Injection[])translator.GetObject(L, 2, typeof(testEvent.Injection[]));
